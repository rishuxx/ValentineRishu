...
const App: React.FC = () => {
  ...
  useEffect(() => {
    localStorage.setItem('ayushi_unlocked_days', JSON.stringify(unlockedPasswords));
  }, [unlockedPasswords]);
      ...
      <footer className="relative z-20 py-10 text-center">
        <div className="glass inline-block px-8 py-3 rounded-full border border-white shadow-lg">
          <p className="font-pacifico text-rose-500 text-xl">
            Made with <span className="animate-pulse inline-block">❤️</span> by Rishu
          </p>
        </div>
      </footer>
